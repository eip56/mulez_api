...
export default function Navigation() {
  ...
  return (
    <div
      className={clsx(
        'border-r-border-800 bg-smoke-900 flex flex-none border-r transition-all duration-200',
        {
          'w-56': sidebar,
          'w-[75px]': !sidebar
        }
            ...
            return (
              <li key={item.label} className="relative">
                <Link
                  ...
                  href={item.href}
                  className={clsx(
                    'text-davy-600 fill-davy-600 group flex items-center gap-4 py-3 pl-[27.5px] text-sm leading-6 hover:text-white group-hover:fill-white group-hover:text-white',
                    {
                      'pl-[27.5px]': !sidebar
                      // 'bg-[#2387FB]': isActive
                    }
